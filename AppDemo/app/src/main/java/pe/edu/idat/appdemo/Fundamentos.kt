...
class Fundamentos {
    ...
    fun ejemplosLambda() {
        ...
        operaciones(10, 4, miFuncionMultiplicacion)
    ...
    private fun operaciones(x: Int, z: Int, operacionesLambda: (Int, Int) -> Int): Int {
        return operacionesLambda(x, z)
    }
    ...
    fun operaciones(numero1: Int, numero2: Int, operacion: String): String {
        // Implementa las operaciones según lo deseado y devuelve el resultado
